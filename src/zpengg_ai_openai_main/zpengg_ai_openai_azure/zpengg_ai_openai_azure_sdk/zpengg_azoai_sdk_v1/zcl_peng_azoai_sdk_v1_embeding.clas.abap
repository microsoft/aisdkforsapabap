...
* Get the actual URL and HTTP communication objects from helper layer.
    _objsdkhelper->get_httpobjs_from_uripattern(
      EXPORTING
        uri_pattern            = zif_peng_azoai_sdk_uripatterns=>version_20221201_endpoint-embeddings-create  "'{endpoint}/openai/deployments/{deployment-id}/embeddings?api-version={version}'
